# Privacy Policy — captured from the old finevines.com, 2026-08-09

Source: `https://www.finevines.com/privacy-policy` (fetched 2026-08-09, before the DNS cutover
makes it unreachable). Footer on the original reads "© 2021 Fine Vines, Inc."
...
2. The original describes practices the new site does not have — Google AdSense advertising, the
   ...
   other page. What the new site actually does: a contact form, and GA4 analytics once the
   measurement ID is set. The published page must describe that, in this document's voice.
...
> Note for the rebuild: "trade" is banned in client-facing copy (client direction, 2026-07-29).
> The published page should say "sell, rent, or otherwise transfer", which carries the same legal
> meaning without the word.
...
Settings page. Alternatively, you can opt out by visiting the Network Advertising Initiative Opt Out
page or by using the Google Analytics Opt Out Browser add on.

> Note for the rebuild: the new site runs no advertising and no AdSense. This whole section is
> false for it. If GA4 is enabled, the published page should describe analytics only.
...
should a data breach occur: We will notify you via email.
...
If at any time you would like to unsubscribe from receiving future emails, you can contact us and we
...
Fine Vines
[street address removed — see the note at the top of this file]
(708) 343-6702
