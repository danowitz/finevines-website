...
// stored value is carried over verbatim at zero API cost. A wine present in
// existing but absent from eligible simply doesn't appear in the result —
// sold-out and delisted wines drop off the site on the next build, and
// "new product" and "sold out" fall out of the same pass.
//
