...
/* Bottle-label placeholder: a tall warm panel standing in for real bottle
   photography (FineVines supplies label shots per SKU). Pass `image` to use
...
try { (() => {
/* FineVines site footer — trade notice, nav, contact, legal. */
function Footer({
  onNav
}) {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\xA9 ", new Date().getFullYear(), " FineVines, Inc. All rights reserved."), /*#__PURE__*/React.createElement("span", {
    style: {
      letterSpacing: '0.1em'
    }
...
try { (() => {
/* FineVines site header — logo, primary nav, trade CTA. */
function Header({
  active,
  onNav
}) {
...
function HomeScreen({
  ...
  }, "Become a FineVines customer"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: 'var(--font-body)',
      fontSize: '19px',
      lineHeight: 1.6,
...
function AboutScreen({
  ...
  }, "FineVines is a licensed wholesale distributor of fine wine. By law, we can only sell to licensed retailers and restaurants within the State of Illinois."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: 'var(--font-body)',
      fontSize: '18px',
      lineHeight: 1.7,
...
function ContactScreen() {
  ...
  }, "FineVines, Inc.", /*#__PURE__*/React.createElement("br", null), "2725 Thomas St", /*#__PURE__*/React.createElement("br", null), "Melrose Park, IL 60160"), /*#__PURE__*/React.createElement("hr", {
    style: {
      border: 'none',
      borderTop: '1px solid var(--border-on-dark)',
      margin: '22px 0'
...
try { (() => {
/* Shared visual parts for the FineVines UI kit. */
...
/* Sample catalog data for the FineVines website UI kit. Producers and wines
   drawn from the real FineVines portfolio (finevines.com). Stand-in copy. */
